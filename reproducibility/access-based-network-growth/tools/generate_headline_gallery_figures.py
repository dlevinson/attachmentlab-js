...
RESULT_ROOT = ROOT / "results" / "baseline_visualisation"
STATE_PATH = RESULT_ROOT / "headline_representative_states.json"
FIGURE_ROOT = RESULT_ROOT / "figures"
EXTENSION_STATE_PATH = ROOT / "results" / "transport_extensions" / "representative_states.json"
...
def main():
    ...
    fig.suptitle("Four model cases: representative graphs and gravity accessibility", y=0.985)
